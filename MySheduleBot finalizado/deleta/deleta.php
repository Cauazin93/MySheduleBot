...
if (!empty($_POST['id_consulta'])) {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            echo "<center><h1>Registro ID $id_consulta excluído com sucesso!</h1></center>";
        } else {
...
echo "<center><a href='../visualiza/visualiza_consulta.php'><input type='button' value='Voltar'></a></center>";
?>
